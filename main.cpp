...
int main() {
    ...
    cout << "Initial state: [pn, pe, pd, vn, ve, vd] = [0, 0, 0, 0, 0, 0]" << endl;
    ...
    for (int i = 0; i < steps; ++i) {
        ...
        if (i % 100 == 0) {
            ...
            cout << "Time: " << time << " s, "
                 << "Position: [" << state_vals[0] << ", " << state_vals[1] << ", " << state_vals[2] << "], "
                 << "Velocity: [" << state_vals[3] << ", " << state_vals[4] << ", " << state_vals[5] << "]" << endl;
        }
    }
    ...
    cout << "Position: [pn, pe, pd] = [" << final_state_vals[0] << ", " << final_state_vals[1] << ", " << final_state_vals[2] << "]" << endl;
    cout << "Velocity: [vn, ve, vd] = [" << final_state_vals[3] << ", " << final_state_vals[4] << ", " << final_state_vals[5] << "]" << endl;

    // 8. 计算理论值并比较
    double theoretical_pd = 0.5 * config.gravity * simulation_time * simulation_time;
